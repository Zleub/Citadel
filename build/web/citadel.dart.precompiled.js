    ...
    call$1: function(character) {
      ...
      if (char_div == null) {
        ...
        if (level_span == null) {
          ...
          level_span.textContent = "level: " + C.JSInt_methods.toString$0(character.get$level()) + " ";
        ...
        if (state_span == null) {
          ...
          state_span.textContent = J.toString$0(J.get$first$ax(t1.get$state(character).get$keys()));
      }
    }
  },
