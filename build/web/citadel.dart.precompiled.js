...
["citadel", "citadel.dart", , X, {
  "^": "",
  main: [function() {
    X.Game$();
  }, "call$0", "main$closure", 0, 0, 1],
  Biome: {
    "^": "Object;name>,graphic,shape",
    toString$0: function(_) {
      return C.JSString_methods.$add(C.JSString_methods.$add("<span class=\"", this.name) + "\">", this.graphic) + "</span>";
    },
    Biome$1: function(biome) {
      var t1 = J.getInterceptor$asx(biome);
      this.name = t1.$index(biome, "name");
      this.graphic = t1.$index(biome, "graphic");
      this.shape = t1.$index(biome, "shape");
    },
    static: {Biome$: function(biome) {
        var t1 = new X.Biome(null, null, null);
        t1.Biome$1(biome);
        return t1;
      }}
  },
  Calendar: {
    "^": "Object;data>,calendar<,_completer",
    Update$2: function(job, rand) {
      var t1 = {};
      t1.job_case_0 = null;
      t1.job_sum_1 = null;
      return this.onLoad$0(0).then$1(new X.Calendar_Update_closure(t1, this, job, rand, []));
    },
    onLoad$0: function(_) {
      this._completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      W.HttpRequest_getString("data/calendar.json", null, null).then$1(new X.Calendar_onLoad_closure(this)).catchError$1(new X.Calendar_onLoad_closure0(this));
      return this._completer.future;
    }
  },
  Calendar_Update_closure: {
    "^": "Closure:13;box_0,this_1,job_2,rand_3,spare_case_4",
    call$1: function($event) {
      var t1, job_case, t2, t3;
      t1 = this.box_0;
      t1.job_sum_1 = 0;
      job_case = J.$index$asx(J.get$data$x(this.job_2), "actions");
      t1.job_case_0 = job_case;
      J.forEach$1$ax(job_case, new X.Calendar_Update__closure(t1));
      P.print(t1.job_sum_1);
      t2 = this.this_1;
      t3 = this.spare_case_4;
      J.forEach$1$ax(t2.calendar, new X.Calendar_Update__closure0(t1, this.rand_3, t3));
      t2.calendar = t3;
    }
  },
  Calendar_Update__closure: {
    "^": "Closure:13;box_0",
    call$1: function(elem) {
      var t1, t2, t3;
      t1 = this.box_0;
      t2 = t1.job_sum_1;
      t3 = J.$index$asx(elem, "time");
      if (typeof t2 !== "number")
        return t2.$add();
      if (typeof t3 !== "number")
        return H.iae(t3);
  ...
  Calendar_Update__closure0: {
    "^": "Closure:13;box_0,rand_5,spare_case_6",
    call$1: function(elem) {
      var t1, t2, times, t3, t4;
      t1 = J.getInterceptor$asx(elem);
      if (!J.$eq(t1.$index(elem, "name"), "Spare"))
        this.spare_case_6.push(elem);
      else {
        t2 = this.box_0;
        times = J.$tdiv$n(t1.$index(elem, "time"), t2.job_sum_1);
        for (t1 = this.spare_case_6, t3 = this.rand_5; t4 = J.getInterceptor(times), !t4.$eq(times, 0);) {
          J.forEach$1$ax(t2.job_case_0, new X.Calendar_Update___closure(t1));
          J.shuffle$1$ax(t2.job_case_0, t3);
          times = t4.$sub(times, 1);
        }
      }
    }
  },
  Calendar_Update___closure: {
    "^": "Closure:15;spare_case_7",
    call$1: function(elem) {
      var t1 = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      t1.addAll$1(0, elem);
      this.spare_case_7.push(t1);
    }
  },
  Calendar_onLoad_closure: {
    "^": "Closure:0;this_0",
    call$1: function(string) {
      var t1, t2;
      t1 = this.this_0;
      t2 = C.JsonCodec_null_null.decode$1(string);
      t1.data = t2;
      t1.calendar = J.$index$asx(t2, "calendar");
  ...
  Calendar_onLoad_closure0: {
    "^": "Closure:13;this_1",
    call$1: function(error) {
      this.this_1._completer.completeError$1(error);
    }
  },
  Character: {
    ...
    updateCalendar$0: function() {
      var skill_shape, skill_list, stat_nbr, t1, rand_loot, index;
      if (++this.time === J.$index$asx(this.state, "time")) {
        skill_shape = J.$index$asx(this.state, "skill_shape");
        if (this.rand.nextInt$1(2) === 0 || J.$eq(J.$index$asx(this.state, "skill_rand"), "none"))
          ;
        else if (J.contains$2$asx(skill_shape, " ", 0)) {
          skill_list = skill_shape.split(" ");
          if (J.$eq(J.$index$asx(this.state, "skill_loot"), "random")) {
            stat_nbr = this.rand.nextInt$1(8);
            t1 = J.$index$asx(this.state, "skill_rand");
            rand_loot = this.rand.nextInt$1(t1);
            if (stat_nbr === 0)
              this.strength += rand_loot;
            else if (stat_nbr === 1)
              this.stamina += rand_loot;
            else if (stat_nbr === 2)
              this.agility += rand_loot;
            else if (stat_nbr === 3)
              this.dexterity += rand_loot;
            else if (stat_nbr === 4)
              this.intelligence += rand_loot;
            else if (stat_nbr === 5)
              this.charisma += rand_loot;
            else if (stat_nbr === 6)
              this.wisdom += rand_loot;
            else if (stat_nbr === 7)
              this.will += rand_loot;
          } else if (J.$eq(J.$index$asx(this.state, "skill_loot"), "all"))
            H.IterableMixinWorkaround_forEach(skill_list, new X.Character_updateCalendar_closure(this));
        ...
        index = J.indexOf$1$asx(this.calendar.calendar, this.state) + 1;
        t1 = J.get$length$asx(this.calendar.calendar);
        if (typeof t1 !== "number")
          return t1.$sub();
        if (index > t1 - 1)
          index = 0;
        this.state = J.elementAt$1$ax(this.calendar.calendar, index);
        this.time = 0;
      }
    },
    updateJoblist$0: function() {
      H.IterableMixinWorkaround_forEach(this.job_list, new X.Character_updateJoblist_closure(this));
    },
    Increment$0: function() {
      var t1, t2, t3;
      t1 = ++this.ticks;
      t2 = this.level;
      t3 = this.strength + this.stamina + this.agility + this.dexterity + this.intelligence + this.charisma + this.wisdom + this.will;
      if (t2 !== t3)
        this.level = t3;
      if (t1 === 21900) {
        ++this.age;
    ...
    hashName$0: function() {
      var hash, i;
      for (hash = 5381, i = 0; i < J.get$length$asx(this.name);) {
        hash = ((hash << 5 >>> 0) + hash ^ J.codeUnitAt$1$s(this.name, i)) >>> 0;
        ++i;
      }
      P.print("hash: " + C.JSInt_methods.toString$0(hash));
      if (hash < 0)
        return hash * -1;
      else
        return hash;
    ...
    Character$1: function($name) {
      ...
      this.job_list = [];
      this.clean_job_list = [];
      P.Future_forEach(["rover", "farmer", "miner", "hunter", "priest", "chief"], new X.Character_closure(this, job_flist)).then$1(new X.Character_closure0(this, job_flist));
      this.experience = 0;
      this.level = 1;
      this.age = 15;
      this.time = 0;
      ...
      this.will = 0;
      t1 = this.hashName$0();
      this.rand = P._Random$(t1);
    },
    static: {Character$: function($name) {
        var t1 = new X.Character($name, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        t1.Character$1($name);
        return t1;
      }}
  },
  Character_updateCalendar_closure: {
    "^": "Closure:13;this_0",
    call$1: function(elem) {
      var t1, t2, rand_loot;
      t1 = this.this_0;
      t2 = J.$index$asx(t1.state, "skill_rand");
      rand_loot = t1.rand.nextInt$1(t2);
      t2 = J.getInterceptor(elem);
      if (t2.$eq(elem, "strength"))
        t1.strength += rand_loot;
      else if (t2.$eq(elem, "stamina"))
        t1.stamina += rand_loot;
      else if (t2.$eq(elem, "agility"))
        t1.agility += rand_loot;
      else if (t2.$eq(elem, "dexterity"))
        t1.dexterity += rand_loot;
      else if (t2.$eq(elem, "intelligence"))
        t1.intelligence += rand_loot;
      else if (t2.$eq(elem, "charisma"))
        t1.charisma += rand_loot;
      else if (t2.$eq(elem, "wisdom"))
        t1.wisdom += rand_loot;
      else if (t2.$eq(elem, "will"))
        t1.will += rand_loot;
    }
  },
  Character_updateJoblist_closure: {
    "^": "Closure:13;this_0",
    call$1: function(job) {
      var t1, t2;
      t1 = this.this_0;
      if (C.JSArray_methods.contains$1(t1.clean_job_list, job))
        ;
      else {
        t2 = J.getInterceptor$x(job);
        if (!J.$eq(J.$index$asx(t2.get$data(job), "requirement"), "none"))
          J.forEach$1$ax(J.$index$asx(t2.get$data(job), "requirement"), new X.Character_updateJoblist__closure(t1, job));
        else
          t1.clean_job_list.push(job);
      }
    }
  },
  Character_updateJoblist__closure: {
    "^": "Closure:13;this_1,job_2",
    call$1: function(test) {
      var t1;
      if (J.$eq(J.get$first$ax(test.get$keys()), "level")) {
        t1 = this.this_1;
        if (J.$le$n(H.Primitives_parseInt(J.get$first$ax(test.get$values(test)), null, null), t1.level))
          t1.clean_job_list.push(this.job_2);
      }
    }
  },
  Character_closure: {
    "^": "Closure:13;this_0,job_flist_1",
    call$1: function(str) {
      var tmp = new X.Job(null, str, null, null);
      this.this_0.job_list.push(tmp);
      this.job_flist_1.push(tmp.onLoad$0(0));
    }
  },
  Character_closure0: {
    "^": "Closure:13;this_2,job_flist_3",
    call$1: function($event) {
      P.Future_wait(this.job_flist_3, false).then$1(new X.Character__closure(this.this_2));
    }
  },
  Character__closure: {
    "^": "Closure:13;this_4",
    call$1: function(elem) {
      var t1, t2;
      t1 = this.this_4;
      t1.job = C.JSArray_methods.get$first(t1.job_list);
      t2 = new X.Calendar(null, null, null);
      t2.onLoad$0(0).then$1(new X.Character___closure(t1));
      t1.calendar = t2;
    }
  },
  Character___closure: {
    ...
    call$1: function($event) {
      var t1 = this.this_5;
      t1.calendar.Update$2(t1.job, t1.rand).then$1(new X.Character____closure(t1));
    }
  },
  Character____closure: {
    "^": "Closure:13;this_6",
    call$1: function($event) {
      var t1 = this.this_6;
      t1.state = J.get$first$ax(t1.calendar.calendar);
    }
  },
  Game: {
    ...
    listWrite$0: function() {
      H.IterableMixinWorkaround_forEach(this.player.char_list, new X.Game_listWrite_closure(this));
    },
    menuWrite$0: function() {
      var dropdown, t1, name_span, strength_span, stamina_span, agility_span, dexterity_span, intelligence_span, charisma_span, wisdom_span, will_span;
      if (this.charmenu != null) {
        dropdown = this.menu.querySelector("#menu_dropdown");
        if (dropdown == null) {
          dropdown = W._ElementFactoryProvider_createElement_tag("nav", null);
          t1 = J.getInterceptor$x(dropdown);
          t1.get$attributes(dropdown)._element.setAttribute("id", "menu_dropdown");
          dropdown.setAttribute("class", "dropdown");
          J.set$$float$x(dropdown.style, "Right");
          t1.insertAdjacentHtml$2(dropdown, "beforeend", "Jobs<br");
          this.dropdown_listen$1(dropdown);
        ...
        if (name_span == null) {
          name_span = document.createElement("span", null);
          name_span.setAttribute("id", "menu_name");
          name_span.setAttribute("class", "menu_name_span");
          this.menu.appendChild(name_span);
        } else {
          name_span.textContent = "";
          J.insertAdjacentHtml$2$x(name_span, "beforeend", J.get$name$x(this.charmenu));
        }
        ...
        if (strength_span == null) {
          ...
          J.insertAdjacentHtml$2$x(strength_span, "beforeend", "Strength: " + C.JSNumber_methods.toString$0(this.charmenu.get$strength()));
        }
        ...
        if (stamina_span == null) {
          ...
          J.insertAdjacentHtml$2$x(stamina_span, "beforeend", "Stamina: " + C.JSNumber_methods.toString$0(this.charmenu.get$stamina()));
        }
        ...
        if (agility_span == null) {
          ...
          J.insertAdjacentHtml$2$x(agility_span, "beforeend", "Agility: " + C.JSNumber_methods.toString$0(this.charmenu.get$agility()));
        }
        ...
        if (dexterity_span == null) {
          ...
          J.insertAdjacentHtml$2$x(dexterity_span, "beforeend", "Dexterity: " + C.JSNumber_methods.toString$0(this.charmenu.get$dexterity()));
        }
        ...
        if (intelligence_span == null) {
          ...
          J.insertAdjacentHtml$2$x(intelligence_span, "beforeend", "Intelligence: " + C.JSNumber_methods.toString$0(this.charmenu.get$intelligence()));
        }
        ...
        if (charisma_span == null) {
          ...
          J.insertAdjacentHtml$2$x(charisma_span, "beforeend", "Charisma: " + C.JSNumber_methods.toString$0(this.charmenu.get$charisma()));
        }
        ...
        if (wisdom_span == null) {
          ...
          J.insertAdjacentHtml$2$x(wisdom_span, "beforeend", "Wisdom: " + C.JSNumber_methods.toString$0(this.charmenu.get$wisdom()));
        }
        ...
        if (will_span == null) {
          ...
          J.insertAdjacentHtml$2$x(will_span, "beforeend", "Will: " + C.JSNumber_methods.toString$0(this.charmenu.get$will()));
        }
      }
    },
    mapWrite$0: function() {
      ...
      t1.i_0 = 0;
      t2 = this.world.mapWorld;
      t2.toString;
      H.IterableMixinWorkaround_forEach(t2, new X.Game_mapWrite_closure(t1, this));
    },
    name_span_listen$1: function(span) {
      var t1, t2;
      t1 = J.getInterceptor$x(span);
      t2 = t1.get$onClick(span);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new X.Game_name_span_listen_closure(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = H.setRuntimeTypeInfo(new W._EventStream(window, C.EventStreamProvider_dblclick._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new X.Game_name_span_listen_closure0(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = t1.get$onMouseMove(span);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new X.Game_name_span_listen_closure1(this, span)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1 = t1.get$onMouseLeave(span);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new X.Game_name_span_listen_closure2(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    dropdown_listen$1: function(dropdown) {
      var t1 = J.get$onMouseEnter$x(dropdown);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new X.Game_dropdown_listen_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    droppiece_listen$1: function(droppiece) {
      var t1 = J.get$onMouseDown$x(droppiece);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new X.Game_droppiece_listen_closure(this, droppiece)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    GameInit$0: function() {
      var t1 = {};
      t1.push_0 = null;
    ...
    runGame$1: [function(Timer) {
      J.remove$0$ax(this.index);
      P.Future_Future(new X.Game_runGame_closure(this), null).then$1(new X.Game_runGame_closure0(this));
    }, "call$1", "get$runGame", 2, 0, 13],
    Game$0: function() {
  ...
  Game_listWrite_closure: {
    "^": "Closure:13;this_0",
    call$1: function(character) {
      var char_list, t1, char_div, name_span, job_span, level_span, state_span;
      char_list = document.body.querySelector("#charlist");
      t1 = J.getInterceptor$x(character);
      char_div = char_list.querySelector(C.JSString_methods.$add("#", t1.get$name(character)));
      if (char_div == null) {
        char_div = document.createElement("div", null);
        char_div.toString;
        char_div.setAttribute("id", t1.get$name(character));
        char_div.setAttribute("class", "char_div");
        char_list.appendChild(char_div);
      } else {
        name_span = char_div.querySelector("#name");
        if (name_span == null) {
          name_span = document.createElement("span", null);
          name_span.setAttribute("id", "name");
          name_span.setAttribute("class", "name_span");
          this.this_0.name_span_listen$1(name_span);
          char_div.appendChild(name_span);
        } else {
          name_span.textContent = "";
          J.insertAdjacentHtml$2$x(name_span, "beforeend", J.padLeft$2$s(t1.get$name(character), 15, "&nbsp") + " ");
        }
        job_span = char_div.querySelector("#job");
        if (job_span == null) {
          job_span = document.createElement("span", null);
          job_span.setAttribute("id", "job");
          job_span.setAttribute("class", "job_span");
          char_div.appendChild(job_span);
        } else
          job_span.textContent = J.$add$ns(J.$index$asx(J.get$data$x(character.get$job()), "name"), " ");
        level_span = char_div.querySelector("#level");
        if (level_span == null) {
          level_span = document.createElement("span", null);
          level_span.setAttribute("id", "level");
          level_span.setAttribute("class", "level_span");
          char_div.appendChild(level_span);
        } else
          level_span.textContent = "level: " + C.JSNumber_methods.toString$0(character.get$level()) + " ";
        state_span = char_div.querySelector("#state");
        if (state_span == null) {
          state_span = document.createElement("span", null);
          state_span.setAttribute("id", "state");
          state_span.setAttribute("class", "state_span");
          char_div.appendChild(state_span);
        } else
          state_span.textContent = J.$index$asx(t1.get$state(character), "name");
      }
    }
  },
  Game_menuWrite_closure: {
    "^": "Closure:13;this_0,dropdown_1",
    call$1: function(elem) {
      var t1, t2, droppiece;
      t1 = this.dropdown_1;
      t2 = J.getInterceptor$x(elem);
      droppiece = t1.querySelector(C.JSString_methods.$add("#menu_", J.$index$asx(t2.get$data(elem), "name")));
      if (droppiece == null) {
        droppiece = W._ElementFactoryProvider_createElement_tag("span", null);
        J.get$attributes$x(droppiece)._element.setAttribute("id", C.JSString_methods.$add("menu_", J.$index$asx(t2.get$data(elem), "name")));
        droppiece.setAttribute("class", "droppiece");
        this.this_0.droppiece_listen$1(droppiece);
        t1.appendChild(droppiece);
      } else
        droppiece.textContent = J.$index$asx(t2.get$data(elem), "name");
    }
  },
  Game_mapWrite_closure: {
    "^": "Closure:13;box_0,this_1",
    call$1: function(elem) {
      var t1, t2, t3, i;
      t1 = this.this_1;
      if (elem == null)
        J.insertAdjacentHtml$2$x(t1.map, "beforeend", "&nbsp;&nbsp;&nbsp;");
      else
        J.insertAdjacentHtml$2$x(t1.map, "beforeend", C.JSString_methods.$add("&nbsp;", J.toString$0(elem)) + "&nbsp;");
      t2 = this.box_0;
      t3 = t2.i_0;
      if (typeof t3 !== "number")
        return t3.$add();
      i = t3 + 1;
      t2.i_0 = i;
      if (C.JSInt_methods.$mod(i, t1.world.sizeWorld) === 0)
        J.insertAdjacentHtml$2$x(t1.map, "beforeend", "<br>");
    }
  },
  Game_name_span_listen_closure: {
    "^": "Closure:13;this_0",
    call$1: function($event) {
      this.this_0.click_bool = 1;
    }
  },
  Game_name_span_listen_closure0: {
    "^": "Closure:13;this_1",
    call$1: function($event) {
      var t1 = this.this_1;
      if (t1.click_bool === 1) {
  ...
  Game_name_span_listen_closure1: {
    "^": "Closure:13;this_2,span_3",
    call$1: function($event) {
      var t1, t2, test;
      t1 = this.this_2;
      t2 = t1.player.char_list;
      test = H.setRuntimeTypeInfo(new H.WhereIterable(t2, new X.Game_name_span_listen__closure(this.span_3)), [H.getTypeArgumentByIndex(H.setRuntimeTypeInfo(new H.IterableMixinWorkaround(), [H.getTypeArgumentByIndex(t2, 0)]), 0)]);
      if (test.get$length(test) === 1) {
        t1.charmenu = test.get$first(test);
        t1.menu.hidden = false;
      }
    }
  },
  Game_name_span_listen__closure: {
    "^": "Closure:13;span_4",
    call$1: function($char) {
      return J.$eq(J.get$name$x($char), J.trim$0$s(this.span_4.textContent));
    }
  },
  Game_name_span_listen_closure2: {
    "^": "Closure:13;this_5",
    call$1: function($event) {
      var t1 = this.this_5;
      if (t1.click_bool === 0)
  ...
  Game_dropdown_listen_closure: {
    "^": "Closure:13;this_0",
    call$1: function($event) {
      var t1, dropdown;
      t1 = this.this_0;
      dropdown = t1.menu.querySelector("#menu_dropdown");
      if (dropdown != null) {
        dropdown.textContent = "";
        J.insertAdjacentHtml$2$x(dropdown, "beforeend", "Jobs<br");
        t1.charmenu.updateJoblist$0();
      }
    }
  },
  Game_droppiece_listen_closure: {
    "^": "Closure:13;this_0,droppiece_1",
    call$1: function($event) {
      var t1, t2, new_job;
      t1 = this.this_0;
      t2 = t1.charmenu.get$clean_job_list();
      new_job = H.setRuntimeTypeInfo(new H.WhereIterable(t2, new X.Game_droppiece_listen__closure(this.droppiece_1)), [H.getTypeArgumentByIndex(H.setRuntimeTypeInfo(new H.IterableMixinWorkaround(), [H.getTypeArgumentByIndex(t2, 0)]), 0)]);
      if (new_job.get$length(new_job) === 1) {
        t1.charmenu.set$job(new_job.get$first(new_job));
        t1.charmenu.get$calendar().Update$2(t1.charmenu.get$job(), t1.charmenu.get$rand());
      } else
        P.print("false job selector");
    }
  },
  Game_droppiece_listen__closure: {
    "^": "Closure:13;droppiece_2",
    call$1: function(job) {
      return J.$eq(J.$index$asx(J.get$data$x(job), "name"), this.droppiece_2.textContent);
    }
  },
  Game_GameInit_closure: {
    "^": "Closure:11;box_0,this_1",
    call$0: function() {
      var t1 = this.this_1;
      t1.body = document.querySelector("#main_row");
      t1.index = document.createElement("div", null);
      t1.charlist = document.createElement("div", null);
      t1.map = document.createElement("div", null);
      t1.menu = document.createElement("div", null);
      this.box_0.push_0 = document.createElement("div", null);
    }
  },
  Game_GameInit_closure0: {
    "^": "Closure:13;box_0,this_2",
    call$1: function($event) {
      var t1, t2;
      t1 = this.this_2;
      J.insertAdjacentHtml$2$x(t1.index, "beforeend", "Hi.<br>What's your name ?<br>");
      J.insertAdjacentHtml$2$x(t1.index, "beforeend", "<input id=\"index\" autofocus>");
      t1.index.setAttribute("class", "index");
      t1.body.appendChild(t1.index);
      t1.charlist.setAttribute("id", "charlist");
      t1.charlist.setAttribute("class", "charlist");
      t1.body.appendChild(t1.charlist);
  ...
  Game_runGame_closure0: {
    "^": "Closure:13;this_1",
    call$1: function($event) {
      var t1, t2;
      t1 = this.this_1;
      H.IterableMixinWorkaround_forEach(t1.player.char_list, new X.Game_runGame__closure());
      H.IterableMixinWorkaround_forEach(t1.player.char_list, new X.Game_runGame__closure0());
      t2 = t1.player.char_list;
      if (t2.length === 1)
        if (C.JSArray_methods.get$first(t2).getRand$1(1000) === 0) {
          P.print("at " + C.JSInt_methods.toString$0(C.JSArray_methods.get$first(t1.player.char_list).get$ticks()));
          t1.player.char_list.push(X.Character$("Vendredi"));
        }
      if (t1.player.checkMinLevel$1(5) && !t1.player.checkChar$1("Isaac"))
        t1.player.char_list.push(X.Character$("Isaac"));
      if (t1.player.checkMinLevel$1(10) && !t1.player.checkChar$1("Nadours"))
        t1.player.char_list.push(X.Character$("Nadours"));
      if (t1.player.checkMinLevel$1(15) && !t1.player.checkChar$1("Mathours"))
        t1.player.char_list.push(X.Character$("Mathours"));
      if (t1.player.checkMinLevel$1(20) && !t1.player.checkChar$1("Chosours"))
        t1.player.char_list.push(X.Character$("Chosours"));
    }
  },
  Game_runGame__closure: {
    "^": "Closure:13;",
    call$1: function(elem) {
      return elem.Increment$0();
    }
  },
  Game_runGame__closure0: {
    "^": "Closure:13;",
    call$1: function(elem) {
      return elem.updateCalendar$0();
    }
  },
  Game_closure: {
    "^": "Closure:13;this_0",
    call$1: function($event) {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new X.Game__closure(this.this_0, input)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    }
  },
  Game__closure: {
    "^": "Closure:13;this_1,input_2",
    call$1: function($event) {
      var t1, t2, t3;
      t1 = this.this_1;
      t1.index.textContent = "Loading";
      t2 = J.get$value$x(this.input_2);
      t3 = new X.Player(t2, null);
      t3.Player$1(t2);
      t1.player = t3;
      t3 = new X.World(20, t3, null, null, null);
      t3.onLoad$0(0).then$1(new X.Game___closure(t1));
      t1.world = t3;
    }
  },
  Game___closure: {
    ...
    call$1: function($event) {
      ...
      t1.mapWrite$0();
      t1.keyEvent$0();
      P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 80, 0, 0), t1.get$runGame());
    }
  },
  Job: {
    "^": "Object;_completer,name>,location,data>",
    onLoad$0: function(_) {
      this._completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      W.HttpRequest_getString(C.JSString_methods.$add("data/", this.name) + ".json", null, null).then$1(new X.Job_onLoad_closure(this)).catchError$1(new X.Job_onLoad_closure0(this));
      return this._completer.future;
    },
    toString$0: function(_) {
  ...
  Job_onLoad_closure: {
    ...
    call$1: function(string) {
      var t1, t2;
      t1 = this.this_0;
      t1.data = C.JsonCodec_null_null.decode$1(string);
      t2 = t1._completer.future;
      if (t2._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t2._asyncComplete$1(t1);
  ...
  Player: {
    "^": "Object;name>,char_list",
    checkMinLevel$1: function(level) {
      return H.IterableMixinWorkaround_any(this.char_list, new X.Player_checkMinLevel_closure(level));
    },
    checkChar$1: function($name) {
      return H.IterableMixinWorkaround_any(this.char_list, new X.Player_checkChar_closure($name));
    },
    Player$1: function($name) {
      var t1 = [];
      this.char_list = t1;
      t1.push(X.Character$(this.name));
    }
  },
  Player_checkMinLevel_closure: {
    "^": "Closure:13;level_0",
    call$1: function(elem) {
      elem.get$level();
      if (elem.level >= this.level_0)
        return true;
      else
        return false;
    }
  },
  Player_checkChar_closure: {
    "^": "Closure:13;name_0",
    call$1: function(elem) {
      var t1 = J.getInterceptor$x(elem);
      if (t1.get$name(elem) != null && J.$eq(t1.get$name(elem), this.name_0))
        return true;
      else
        return false;
    }
  ...
  World: {
    "^": "Object;sizeWorld,player,mapWorld,_completer,data>",
    getWilderness$1: function(citadel) {
      var wilderness = J.where$1$ax(citadel, new X.World_getWilderness_closure());
      if (wilderness.get$length(wilderness) === 1)
        return X.Biome$(wilderness.get$first(wilderness));
      else
        return;
    },
    getMountain$0: function() {
      var mountain, t1, t2, t3;
      mountain = J.where$1$ax(J.$index$asx(this.data, "ground"), new X.World_getMountain_closure());
      if (mountain.get$length(mountain) === 1) {
        t1 = mountain.get$first(mountain);
        t2 = new X.Biome(null, null, null);
        t3 = J.getInterceptor$asx(t1);
        t2.name = t3.$index(t1, "name");
        t2.graphic = t3.$index(t1, "graphic");
        t2.shape = t3.$index(t1, "shape");
        return t2;
      } else
        return;
    },
    getfillbiome$1: function(ground) {
      var fillbiome, t1, t2, t3;
      fillbiome = J.where$1$ax(ground, new X.World_getfillbiome_closure());
      if (fillbiome.get$length(fillbiome) === 1) {
        t1 = fillbiome.get$first(fillbiome);
        t2 = new X.Biome(null, null, null);
        t3 = J.getInterceptor$asx(t1);
        t2.name = t3.$index(t1, "name");
        t2.graphic = t3.$index(t1, "graphic");
    ...
    drawCircle$4: function(x, y, bonus, biome) {
      var radius, j, t1, t2, t3, t4, t5, j0, t6, i, t7, t8, t9;
      radius = C.JSArray_methods.get$first(this.player.char_list).getRand$1(2) + bonus;
      j = -radius;
      t1 = this.mapWorld;
      t2 = this.sizeWorld;
      t3 = x + y * t2;
      t4 = new X.Biome(null, null, null);
      t5 = J.getInterceptor$asx(biome);
      t4.name = t5.$index(biome, "name");
      t4.graphic = t5.$index(biome, "graphic");
      t4.shape = t5.$index(biome, "shape");
      if (t3 >>> 0 !== t3 || t3 >= t1.length)
        return H.ioore(t1, t3);
      t1[t3] = t4;
      for (t1 = radius * radius + radius * 0.8, t3 = t2 * t2, j0 = j; j0 <= radius;) {
        for (t4 = j0 * j0, t6 = (j0 + y) * t2, i = j; i <= radius;) {
          if (i * i + t4 <= t1) {
            t7 = i + x + t6;
            if (t7 >= 0)
              if (t7 < t3) {
          ...
          if (t7) {
            t7 = this.mapWorld;
            t8 = i + x + t6;
            t9 = new X.Biome(null, null, null);
            t9.name = t5.$index(biome, "name");
            t9.graphic = t5.$index(biome, "graphic");
            t9.shape = t5.$index(biome, "shape");
    ...
    drawMCircle$5: function(map, x, y, bonus, index) {
      var j, t1, t2, t3, t4, j0, t5, t6, i, t7;
      j = -bonus;
      for (t1 = bonus * bonus + bonus * 0.8, t2 = this.sizeWorld, t3 = t2 * t2, t4 = map.length, j0 = j; j0 <= bonus;) {
        for (t5 = j0 * j0, t6 = (j0 + y) * t2, i = j; i <= bonus;) {
          if (i * i + t5 <= t1) {
            t7 = i + x + t6;
            t7 = t7 >= 0 && t7 < t3;
          } else
    ...
    drawMountain$0: function() {
      var t1, t2, tmp, i, biomeNbr, i0, t3, t4, t5, t6;
      t1 = this.sizeWorld;
      t2 = t1 * t1;
      tmp = Array(t2);
      for (i = 0; i < t2;) {
      ...
      biomeNbr = C.JSArray_methods.get$first(this.player.char_list).getRand$1(3) + 1;
      for (; biomeNbr !== 0;) {
        this.drawMCircle$5(tmp, C.JSArray_methods.get$first(this.player.char_list).getRand$1(t1), C.JSArray_methods.get$first(this.player.char_list).getRand$1(t1), 7, 1);
        --biomeNbr;
      }
      for (i = 1; i < t2; i = i0) {
        i0 = i + 1;
    ...
    drawWater$0: function() {
      var water, t1, biomeNbr, t2;
      water = J.$index$asx(this.data, "water");
      t1 = this.sizeWorld;
      biomeNbr = C.JSArray_methods.get$first(this.player.char_list).getRand$1(6) + (t1 / 10 | 0);
      for (t2 = J.getInterceptor$asx(water); biomeNbr !== 0;) {
        this.drawCircle$4(C.JSArray_methods.get$first(this.player.char_list).getRand$1(t1), C.JSArray_methods.get$first(this.player.char_list).getRand$1(t1), 1, t2.$index(water, C.JSArray_methods.get$first(this.player.char_list).getRand$1(t2.get$length(water))));
        --biomeNbr;
      }
    },
    drawGround$0: function() {
      var _ground, t1, biomeNbr;
      _ground = J.where$1$ax(J.$index$asx(this.data, "ground"), new X.World_drawGround_closure());
      t1 = this.sizeWorld;
      biomeNbr = C.JSArray_methods.get$first(this.player.char_list).getRand$1(6) + (t1 / 5 | 0);
      for (; biomeNbr !== 0;) {
        this.drawCircle$4(C.JSArray_methods.get$first(this.player.char_list).getRand$1(t1), C.JSArray_methods.get$first(this.player.char_list).getRand$1(t1), 2, _ground.elementAt$1(0, C.JSArray_methods.get$first(this.player.char_list).getRand$1(_ground.get$length(_ground))));
        --biomeNbr;
      }
    },
    fillmap$0: function() {
      return P.Future_Future(new X.World_fillmap_closure(this), null);
    },
    onLoad$0: function(_) {
      var t1;
      this._completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      t1 = this.sizeWorld;
      this.mapWorld = Array(t1 * t1);
      W.HttpRequest_getString("data/biomes.json", null, null).then$1(new X.World_onLoad_closure(this)).catchError$1(new X.World_onLoad_closure0(this));
      return this._completer.future;
    }
  },
  World_getWilderness_closure: {
    "^": "Closure:13;",
    call$1: function(elem) {
      if (J.$eq(J.$index$asx(elem, "requirement"), "none"))
        return true;
      else
        return false;
    }
  },
  World_getMountain_closure: {
    "^": "Closure:13;",
    call$1: function(elem) {
      if (J.$eq(J.$index$asx(elem, "shape"), "mountain"))
        return true;
      else
        return false;
    }
  },
  World_getfillbiome_closure: {
    "^": "Closure:13;",
    call$1: function(elem) {
      if (J.$eq(J.$index$asx(elem, "shape"), "fill"))
        return true;
      else
        return false;
    }
  },
  World_drawGround_closure: {
    "^": "Closure:13;",
    call$1: function(elem) {
      var t1 = J.getInterceptor$asx(elem);
      return !J.$eq(t1.$index(elem, "shape"), "fill") && !J.$eq(t1.$index(elem, "shape"), "mountain");
    }
  },
  World_fillmap_closure: {
    "^": "Closure:11;this_0",
    call$0: function() {
      var t1, wilderness, t2, t3, t4, i;
      t1 = this.this_0;
      t1.drawMountain$0();
      wilderness = t1.getWilderness$1(J.$index$asx(t1.data, "citadel"));
      t2 = t1.mapWorld;
      t3 = t1.sizeWorld;
      t4 = t3 / 2 | 0;
      t4 += t4 * t3;
      ...
      t1.drawWater$0();
      t1.drawGround$0();
      for (t2 = t3 * t3, i = 0; i < t2;) {
        t3 = t1.mapWorld;
        if (i >= t3.length)
          return H.ioore(t3, i);
        if (t3[i] == null)
          t3[i] = t1.getfillbiome$1(J.$index$asx(t1.data, "ground"));
        ++i;
      }
    }
  },
  World_onLoad_closure: {
    "^": "Closure:0;this_0",
    call$1: function(string) {
      var t1 = this.this_0;
      t1.data = C.JsonCodec_null_null.decode$1(string);
      t1.fillmap$0().then$1(new X.World_onLoad__closure(t1));
    }
  },
  World_onLoad__closure: {
    "^": "Closure:13;this_1",
    call$1: function($event) {
      var t1, t2;
      t1 = this.this_1;
  ...
  World_onLoad_closure0: {
    "^": "Closure:13;this_2",
    call$1: function(error) {
      this.this_2._completer.completeError$1(error);
    }
  }
},
1],
...
["dart.async", "dart:async", , P, {
  ...
  Future_forEach: function(input, f) {
    return P.Future_doWhile(new P.Future_forEach_closure(f, new H.ListIterator(input, 6, 0, null)));
  },
  ...
  Future_forEach__closure: {
    "^": "Closure:11;f_2,iterator_3",
    call$0: function() {
      return this.f_2.call$1(this.iterator_3._current);
    }
  },
  ...
  Future_doWhile_closure: {
    "^": "Closure:18;box_0,f_1,doneSignal_2",
...
["dart.dom.html", "dart:html", , W, {
  ...
  Event: {
    "^": "Interceptor;",
    "%": "AudioProcessingEvent|AutocompleteErrorEvent|BeforeLoadEvent|BeforeUnloadEvent|CSSFontFaceLoadEvent|CloseEvent|CustomEvent|DeviceMotionEvent|DeviceOrientationEvent|HashChangeEvent|IDBVersionChangeEvent|InstallEvent|InstallPhaseEvent|MIDIConnectionEvent|MediaKeyEvent|MediaKeyMessageEvent|MediaKeyNeededEvent|MediaStreamEvent|MediaStreamTrackEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|RTCDTMFToneChangeEvent|RTCDataChannelEvent|RTCIceCandidateEvent|SecurityPolicyViolationEvent|SpeechInputEvent|SpeechRecognitionEvent|StorageEvent|TrackEvent|TransitionEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent;ClipboardEvent|Event|InputEvent"
  },
  EventTarget: {
    "^": "Interceptor;",
...
//# sourceMappingURL=citadel.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function Biome(name, graphic, shape) {
    this.name = name;
    this.graphic = graphic;
    this.shape = shape;
  }
  Biome.builtin$cls = "Biome";
  if (!"name" in Biome)
    Biome.name = "Biome";
  $desc = $collectedClasses.Biome;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Biome.prototype = $desc;
  Biome.prototype.get$name = function(receiver) {
    return this.name;
  };
  function Calendar(data, calendar, _completer) {
    this.data = data;
    this.calendar = calendar;
    this._completer = _completer;
  }
  Calendar.builtin$cls = "Calendar";
  if (!"name" in Calendar)
    Calendar.name = "Calendar";
  $desc = $collectedClasses.Calendar;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calendar.prototype = $desc;
  Calendar.prototype.get$data = function(receiver) {
    return this.data;
  };
  Calendar.prototype.get$calendar = function() {
    return this.calendar;
  };
  function Calendar_Update_closure(box_0, this_1, job_2, rand_3, spare_case_4) {
    this.box_0 = box_0;
    this.this_1 = this_1;
    this.job_2 = job_2;
    this.rand_3 = rand_3;
    this.spare_case_4 = spare_case_4;
  }
  Calendar_Update_closure.builtin$cls = "Calendar_Update_closure";
  if (!"name" in Calendar_Update_closure)
    Calendar_Update_closure.name = "Calendar_Update_closure";
  $desc = $collectedClasses.Calendar_Update_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calendar_Update_closure.prototype = $desc;
  function Calendar_Update__closure(box_0) {
    this.box_0 = box_0;
  }
  Calendar_Update__closure.builtin$cls = "Calendar_Update__closure";
  if (!"name" in Calendar_Update__closure)
    Calendar_Update__closure.name = "Calendar_Update__closure";
  $desc = $collectedClasses.Calendar_Update__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calendar_Update__closure.prototype = $desc;
  function Calendar_Update__closure0(box_0, rand_5, spare_case_6) {
    this.box_0 = box_0;
    this.rand_5 = rand_5;
    this.spare_case_6 = spare_case_6;
  }
  Calendar_Update__closure0.builtin$cls = "Calendar_Update__closure0";
  if (!"name" in Calendar_Update__closure0)
    Calendar_Update__closure0.name = "Calendar_Update__closure0";
  $desc = $collectedClasses.Calendar_Update__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calendar_Update__closure0.prototype = $desc;
  function Calendar_Update___closure(spare_case_7) {
    this.spare_case_7 = spare_case_7;
  }
  Calendar_Update___closure.builtin$cls = "Calendar_Update___closure";
  if (!"name" in Calendar_Update___closure)
    Calendar_Update___closure.name = "Calendar_Update___closure";
  $desc = $collectedClasses.Calendar_Update___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calendar_Update___closure.prototype = $desc;
  function Calendar_onLoad_closure(this_0) {
    this.this_0 = this_0;
  }
  Calendar_onLoad_closure.builtin$cls = "Calendar_onLoad_closure";
  if (!"name" in Calendar_onLoad_closure)
    Calendar_onLoad_closure.name = "Calendar_onLoad_closure";
  $desc = $collectedClasses.Calendar_onLoad_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calendar_onLoad_closure.prototype = $desc;
  function Calendar_onLoad_closure0(this_1) {
    this.this_1 = this_1;
  }
  Calendar_onLoad_closure0.builtin$cls = "Calendar_onLoad_closure0";
  if (!"name" in Calendar_onLoad_closure0)
    Calendar_onLoad_closure0.name = "Calendar_onLoad_closure0";
  $desc = $collectedClasses.Calendar_onLoad_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Calendar_onLoad_closure0.prototype = $desc;
  function Character(name, hash, experience, level, age, job, job_list, clean_job_list, time, calendar, state, ticks, rand, strength, stamina, agility, dexterity, intelligence, charisma, wisdom, will) {
    this.name = name;
    this.hash = hash;
    ...
    this.clean_job_list = clean_job_list;
    this.time = time;
    this.calendar = calendar;
    this.state = state;
    this.ticks = ticks;
  ...
  Character.prototype.get$level = function() {
    return this.level;
  };
  Character.prototype.get$job = function() {
    return this.job;
  };
  Character.prototype.set$job = function(v) {
    return this.job = v;
  };
  Character.prototype.get$clean_job_list = function() {
    return this.clean_job_list;
  };
  Character.prototype.get$calendar = function() {
    return this.calendar;
  };
  Character.prototype.get$state = function(receiver) {
    return this.state;
  };
  Character.prototype.get$ticks = function() {
    return this.ticks;
  };
  Character.prototype.get$rand = function() {
    return this.rand;
  };
  ...
  function Character_updateCalendar_closure(this_0) {
    this.this_0 = this_0;
  }
  Character_updateCalendar_closure.builtin$cls = "Character_updateCalendar_closure";
  if (!"name" in Character_updateCalendar_closure)
    Character_updateCalendar_closure.name = "Character_updateCalendar_closure";
  $desc = $collectedClasses.Character_updateCalendar_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Character_updateCalendar_closure.prototype = $desc;
  function Character_updateJoblist_closure(this_0) {
    this.this_0 = this_0;
  }
  Character_updateJoblist_closure.builtin$cls = "Character_updateJoblist_closure";
  if (!"name" in Character_updateJoblist_closure)
    Character_updateJoblist_closure.name = "Character_updateJoblist_closure";
  $desc = $collectedClasses.Character_updateJoblist_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Character_updateJoblist_closure.prototype = $desc;
  function Character_updateJoblist__closure(this_1, job_2) {
    this.this_1 = this_1;
    this.job_2 = job_2;
  }
  Character_updateJoblist__closure.builtin$cls = "Character_updateJoblist__closure";
  if (!"name" in Character_updateJoblist__closure)
    Character_updateJoblist__closure.name = "Character_updateJoblist__closure";
  $desc = $collectedClasses.Character_updateJoblist__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Character_updateJoblist__closure.prototype = $desc;
  function Character_closure(this_0, job_flist_1) {
    this.this_0 = this_0;
    this.job_flist_1 = job_flist_1;
  }
  Character_closure.builtin$cls = "Character_closure";
  if (!"name" in Character_closure)
    Character_closure.name = "Character_closure";
  $desc = $collectedClasses.Character_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Character_closure.prototype = $desc;
  function Character_closure0(this_2, job_flist_3) {
    this.this_2 = this_2;
    this.job_flist_3 = job_flist_3;
  }
  Character_closure0.builtin$cls = "Character_closure0";
  if (!"name" in Character_closure0)
    Character_closure0.name = "Character_closure0";
  $desc = $collectedClasses.Character_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Character_closure0.prototype = $desc;
  function Character__closure(this_4) {
    this.this_4 = this_4;
  }
  Character__closure.builtin$cls = "Character__closure";
  if (!"name" in Character__closure)
    Character__closure.name = "Character__closure";
  $desc = $collectedClasses.Character__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Character__closure.prototype = $desc;
  function Character___closure(this_5) {
    this.this_5 = this_5;
  }
  Character___closure.builtin$cls = "Character___closure";
  if (!"name" in Character___closure)
    Character___closure.name = "Character___closure";
  $desc = $collectedClasses.Character___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Character___closure.prototype = $desc;
  function Character____closure(this_6) {
    this.this_6 = this_6;
  }
  Character____closure.builtin$cls = "Character____closure";
  if (!"name" in Character____closure)
    Character____closure.name = "Character____closure";
  $desc = $collectedClasses.Character____closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Character____closure.prototype = $desc;
  function Game(player, calendar, world, charmenu, body, index, charlist, map, menu, click_bool, panel_show) {
    this.player = player;
    this.calendar = calendar;
    this.world = world;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game.prototype = $desc;
  Game.prototype.get$calendar = function() {
    return this.calendar;
  };
  function Game_keyEvent_closure(this_0) {
    this.this_0 = this_0;
  }
  Game_keyEvent_closure.builtin$cls = "Game_keyEvent_closure";
  if (!"name" in Game_keyEvent_closure)
    Game_keyEvent_closure.name = "Game_keyEvent_closure";
  $desc = $collectedClasses.Game_keyEvent_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_keyEvent_closure.prototype = $desc;
  function Game_listWrite_closure(this_0) {
    this.this_0 = this_0;
  }
  Game_listWrite_closure.builtin$cls = "Game_listWrite_closure";
  if (!"name" in Game_listWrite_closure)
    Game_listWrite_closure.name = "Game_listWrite_closure";
  $desc = $collectedClasses.Game_listWrite_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_listWrite_closure.prototype = $desc;
  function Game_menuWrite_closure(this_0, dropdown_1) {
    this.this_0 = this_0;
    this.dropdown_1 = dropdown_1;
  }
  Game_menuWrite_closure.builtin$cls = "Game_menuWrite_closure";
  if (!"name" in Game_menuWrite_closure)
    Game_menuWrite_closure.name = "Game_menuWrite_closure";
  $desc = $collectedClasses.Game_menuWrite_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_menuWrite_closure.prototype = $desc;
  function Game_mapWrite_closure(box_0, this_1) {
    this.box_0 = box_0;
    this.this_1 = this_1;
  }
  Game_mapWrite_closure.builtin$cls = "Game_mapWrite_closure";
  if (!"name" in Game_mapWrite_closure)
    Game_mapWrite_closure.name = "Game_mapWrite_closure";
  $desc = $collectedClasses.Game_mapWrite_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_mapWrite_closure.prototype = $desc;
  function Game_name_span_listen_closure(this_0) {
    this.this_0 = this_0;
  }
  Game_name_span_listen_closure.builtin$cls = "Game_name_span_listen_closure";
  if (!"name" in Game_name_span_listen_closure)
    Game_name_span_listen_closure.name = "Game_name_span_listen_closure";
  $desc = $collectedClasses.Game_name_span_listen_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_name_span_listen_closure.prototype = $desc;
  function Game_name_span_listen_closure0(this_1) {
    this.this_1 = this_1;
  }
  Game_name_span_listen_closure0.builtin$cls = "Game_name_span_listen_closure0";
  if (!"name" in Game_name_span_listen_closure0)
    Game_name_span_listen_closure0.name = "Game_name_span_listen_closure0";
  $desc = $collectedClasses.Game_name_span_listen_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_name_span_listen_closure0.prototype = $desc;
  function Game_name_span_listen_closure1(this_2, span_3) {
    this.this_2 = this_2;
    this.span_3 = span_3;
  }
  Game_name_span_listen_closure1.builtin$cls = "Game_name_span_listen_closure1";
  if (!"name" in Game_name_span_listen_closure1)
    Game_name_span_listen_closure1.name = "Game_name_span_listen_closure1";
  $desc = $collectedClasses.Game_name_span_listen_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_name_span_listen_closure1.prototype = $desc;
  function Game_name_span_listen__closure(span_4) {
    this.span_4 = span_4;
  }
  Game_name_span_listen__closure.builtin$cls = "Game_name_span_listen__closure";
  if (!"name" in Game_name_span_listen__closure)
    Game_name_span_listen__closure.name = "Game_name_span_listen__closure";
  $desc = $collectedClasses.Game_name_span_listen__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_name_span_listen__closure.prototype = $desc;
  function Game_name_span_listen_closure2(this_5) {
    this.this_5 = this_5;
  }
  Game_name_span_listen_closure2.builtin$cls = "Game_name_span_listen_closure2";
  if (!"name" in Game_name_span_listen_closure2)
    Game_name_span_listen_closure2.name = "Game_name_span_listen_closure2";
  $desc = $collectedClasses.Game_name_span_listen_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_name_span_listen_closure2.prototype = $desc;
  function Game_dropdown_listen_closure(this_0) {
    this.this_0 = this_0;
  }
  Game_dropdown_listen_closure.builtin$cls = "Game_dropdown_listen_closure";
  if (!"name" in Game_dropdown_listen_closure)
    Game_dropdown_listen_closure.name = "Game_dropdown_listen_closure";
  $desc = $collectedClasses.Game_dropdown_listen_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_dropdown_listen_closure.prototype = $desc;
  function Game_droppiece_listen_closure(this_0, droppiece_1) {
    this.this_0 = this_0;
    this.droppiece_1 = droppiece_1;
  }
  Game_droppiece_listen_closure.builtin$cls = "Game_droppiece_listen_closure";
  if (!"name" in Game_droppiece_listen_closure)
    Game_droppiece_listen_closure.name = "Game_droppiece_listen_closure";
  $desc = $collectedClasses.Game_droppiece_listen_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_droppiece_listen_closure.prototype = $desc;
  function Game_droppiece_listen__closure(droppiece_2) {
    this.droppiece_2 = droppiece_2;
  }
  Game_droppiece_listen__closure.builtin$cls = "Game_droppiece_listen__closure";
  if (!"name" in Game_droppiece_listen__closure)
    Game_droppiece_listen__closure.name = "Game_droppiece_listen__closure";
  $desc = $collectedClasses.Game_droppiece_listen__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_droppiece_listen__closure.prototype = $desc;
  function Game_GameInit_closure(box_0, this_1) {
    this.box_0 = box_0;
    this.this_1 = this_1;
  }
  Game_GameInit_closure.builtin$cls = "Game_GameInit_closure";
  if (!"name" in Game_GameInit_closure)
    Game_GameInit_closure.name = "Game_GameInit_closure";
  $desc = $collectedClasses.Game_GameInit_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  if (!"name" in Game_GameInit_closure0)
    Game_GameInit_closure0.name = "Game_GameInit_closure0";
  $desc = $collectedClasses.Game_GameInit_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_GameInit_closure0.prototype = $desc;
  function Game_runGame_closure(this_0) {
    this.this_0 = this_0;
  }
  Game_runGame_closure.builtin$cls = "Game_runGame_closure";
  if (!"name" in Game_runGame_closure)
    Game_runGame_closure.name = "Game_runGame_closure";
  $desc = $collectedClasses.Game_runGame_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_runGame_closure.prototype = $desc;
  function Game_runGame_closure0(this_1) {
    this.this_1 = this_1;
  }
  Game_runGame_closure0.builtin$cls = "Game_runGame_closure0";
  if (!"name" in Game_runGame_closure0)
    Game_runGame_closure0.name = "Game_runGame_closure0";
  $desc = $collectedClasses.Game_runGame_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_runGame_closure0.prototype = $desc;
  function Game_runGame__closure() {
  }
  Game_runGame__closure.builtin$cls = "Game_runGame__closure";
  if (!"name" in Game_runGame__closure)
    Game_runGame__closure.name = "Game_runGame__closure";
  $desc = $collectedClasses.Game_runGame__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_runGame__closure.prototype = $desc;
  function Game_runGame__closure0() {
  }
  Game_runGame__closure0.builtin$cls = "Game_runGame__closure0";
  if (!"name" in Game_runGame__closure0)
    Game_runGame__closure0.name = "Game_runGame__closure0";
  $desc = $collectedClasses.Game_runGame__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_runGame__closure0.prototype = $desc;
  ...
  function Game__closure(this_1, input_2) {
    this.this_1 = this_1;
    this.input_2 = input_2;
  }
  Game__closure.builtin$cls = "Game__closure";
  if (!"name" in Game__closure)
    Game__closure.name = "Game__closure";
  $desc = $collectedClasses.Game__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game__closure.prototype = $desc;
  function Game___closure(this_3) {
    this.this_3 = this_3;
  }
  Game___closure.builtin$cls = "Game___closure";
  if (!"name" in Game___closure)
    Game___closure.name = "Game___closure";
  $desc = $collectedClasses.Game___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game___closure.prototype = $desc;
  function Job(_completer, name, location, data) {
    this._completer = _completer;
    this.name = name;
  ...
  Job.prototype.get$data = function(receiver) {
    return this.data;
  };
  function Job_onLoad_closure(this_0) {
    this.this_0 = this_0;
  }
  Job_onLoad_closure.builtin$cls = "Job_onLoad_closure";
  if (!"name" in Job_onLoad_closure)
    Job_onLoad_closure.name = "Job_onLoad_closure";
  $desc = $collectedClasses.Job_onLoad_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Job_onLoad_closure.prototype = $desc;
  function Job_onLoad_closure0(this_1) {
    this.this_1 = this_1;
  }
  Job_onLoad_closure0.builtin$cls = "Job_onLoad_closure0";
  if (!"name" in Job_onLoad_closure0)
    Job_onLoad_closure0.name = "Job_onLoad_closure0";
  $desc = $collectedClasses.Job_onLoad_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Job_onLoad_closure0.prototype = $desc;
  function Player(name, char_list) {
    this.name = name;
  ...
  Player.prototype.get$name = function(receiver) {
    return this.name;
  };
  function Player_checkMinLevel_closure(level_0) {
    this.level_0 = level_0;
  }
  Player_checkMinLevel_closure.builtin$cls = "Player_checkMinLevel_closure";
  if (!"name" in Player_checkMinLevel_closure)
    Player_checkMinLevel_closure.name = "Player_checkMinLevel_closure";
  $desc = $collectedClasses.Player_checkMinLevel_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Player_checkMinLevel_closure.prototype = $desc;
  function Player_checkChar_closure(name_0) {
    this.name_0 = name_0;
  }
  Player_checkChar_closure.builtin$cls = "Player_checkChar_closure";
  if (!"name" in Player_checkChar_closure)
    Player_checkChar_closure.name = "Player_checkChar_closure";
  $desc = $collectedClasses.Player_checkChar_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Player_checkChar_closure.prototype = $desc;
  function World(sizeWorld, player, mapWorld, _completer, data) {
  ...
  World.prototype.get$data = function(receiver) {
    return this.data;
  };
  function World_getWilderness_closure() {
  }
  World_getWilderness_closure.builtin$cls = "World_getWilderness_closure";
  if (!"name" in World_getWilderness_closure)
    World_getWilderness_closure.name = "World_getWilderness_closure";
  $desc = $collectedClasses.World_getWilderness_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  World_getWilderness_closure.prototype = $desc;
  function World_getMountain_closure() {
  }
  World_getMountain_closure.builtin$cls = "World_getMountain_closure";
  if (!"name" in World_getMountain_closure)
    World_getMountain_closure.name = "World_getMountain_closure";
  $desc = $collectedClasses.World_getMountain_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  World_getMountain_closure.prototype = $desc;
  function World_getfillbiome_closure() {
  }
  World_getfillbiome_closure.builtin$cls = "World_getfillbiome_closure";
  if (!"name" in World_getfillbiome_closure)
    World_getfillbiome_closure.name = "World_getfillbiome_closure";
  $desc = $collectedClasses.World_getfillbiome_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  World_getfillbiome_closure.prototype = $desc;
  function World_drawGround_closure() {
  }
  World_drawGround_closure.builtin$cls = "World_drawGround_closure";
  if (!"name" in World_drawGround_closure)
    World_drawGround_closure.name = "World_drawGround_closure";
  $desc = $collectedClasses.World_drawGround_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  World_drawGround_closure.prototype = $desc;
  function World_fillmap_closure(this_0) {
    this.this_0 = this_0;
  }
  World_fillmap_closure.builtin$cls = "World_fillmap_closure";
  if (!"name" in World_fillmap_closure)
    World_fillmap_closure.name = "World_fillmap_closure";
  $desc = $collectedClasses.World_fillmap_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  World_fillmap_closure.prototype = $desc;
  function World_onLoad_closure(this_0) {
    this.this_0 = this_0;
  }
  World_onLoad_closure.builtin$cls = "World_onLoad_closure";
  if (!"name" in World_onLoad_closure)
    World_onLoad_closure.name = "World_onLoad_closure";
  $desc = $collectedClasses.World_onLoad_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  World_onLoad_closure.prototype = $desc;
  function World_onLoad__closure(this_1) {
    this.this_1 = this_1;
  }
  World_onLoad__closure.builtin$cls = "World_onLoad__closure";
  if (!"name" in World_onLoad__closure)
    World_onLoad__closure.name = "World_onLoad__closure";
  $desc = $collectedClasses.World_onLoad__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  World_onLoad__closure.prototype = $desc;
  function World_onLoad_closure0(this_2) {
    this.this_2 = this_2;
  }
  World_onLoad_closure0.builtin$cls = "World_onLoad_closure0";
  if (!"name" in World_onLoad_closure0)
    World_onLoad_closure0.name = "World_onLoad_closure0";
  $desc = $collectedClasses.World_onLoad_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  World_onLoad_closure0.prototype = $desc;
  ...
  function Future_forEach_closure(f_0, iterator_1) {
    this.f_0 = f_0;
  ...
  $desc = $collectedClasses.Future_forEach_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Future_forEach_closure.prototype = $desc;
  function Future_forEach__closure(f_2, iterator_3) {
    this.f_2 = f_2;
    this.iterator_3 = iterator_3;
  }
  ...
  $desc = $collectedClasses.Future_forEach__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  $desc = $collectedClasses.Future_forEach__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Future_forEach__closure0.prototype = $desc;
  function Future_doWhile_closure(box_0, f_1, doneSignal_2) {
    this.box_0 = box_0;
    this.f_1 = f_1;
    this.doneSignal_2 = doneSignal_2;
  }
  ...
  $desc = $collectedClasses.Future_doWhile_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
