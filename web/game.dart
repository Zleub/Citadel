...
//			print(event.keyCode);
		...
		querySelector('#icons').onClick.listen( (event)
		{
			if (panel_show == 0)
			{
				charlist.remove();
	...
	listInit()
	{
		DivElement icons = new DivElement();
		icons.attributes['id'] = 'icons';
		icons.appendHtml('<img src="img/north.png" alt="map" title="View map (M)">');
		body.append(icons);
...
//                body.append(push);
	...
	runGame(Timer)
   	{
   		index.remove();
   		querySelector('#icons').attributes['style'] = "display: block;";
